          ...
          <div className="home-inner container">
            <div className="row">
                <div className="col-lg-8 d-none d-lg-block marg-lg-zeus">
                    <h1 className="display-4 mt-4">Welcome to Authors Haven, <br />Creative at Heart</h1>
                ...
                <div className="col-lg-4 my-5">
                    <div className="card bg-primary text-center card-form">
                        <div className="card-body">
                            ...
                            <Link to="/register" className="btn btn-dark mr-1">Get Started</Link>
                            <Link to="#learnmore" className="btn btn-outline-light">Learn More</Link>
                        </div>
                    </div>
                </div>
            </div>
