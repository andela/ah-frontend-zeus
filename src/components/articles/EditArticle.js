...
export class EditArticle extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    const body = nextProps.article.articles.article.body;
    const title = nextProps.article.articles.article.title;
    const description = nextProps.article.articles.article.description;
    const images = nextProps.article.articles.article.images;
    const values = {
      title: title,
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-10 m-auto">
                <div className="card">
                  <div className="card-header zeus-color text-white">
                    Create New Article
                  </div>
