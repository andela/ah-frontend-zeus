...
import { responseFacebook, responseGoogle, fetchUser } from "../../actions/socialAction";
...
const mockStore = configureMockStore(middlewares);
 ...
 describe("Google login ", () => {
  ...
  it("Tests signing in with Google", () => {
    ...
    fetchMock.post('https://zeus-staging.herokuapp.com/api/social/auth/google/', {
      headers: {
 ...
 describe("Facebook login ", () => {
  ...
  it("Tests signing in with facebook", () => {
    ...
    let token = {auth_token: "RTYRTTRURTUR"}
    let data  =  {user: {auth_token: "RTYRTTRURTUR"}};
    fetchMock.post('https://zeus-staging.herokuapp.com/api/social/auth/facebook/', {
      headers: {
        "content-type": "application/json"
      },
      body: JSON.stringify({ user: token })
